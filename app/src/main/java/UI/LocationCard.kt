...
fun locationAccess(context: Context): String {
    ...
    return when {
        ...
        has(ACCESS_FINE_LOCATION) ->
            "Precise"

        has(ACCESS_COARSE_LOCATION) ->
            "Approximate"
...
fun LocationCard() {
    ...
    var text by remember {
        mutableStateOf(
            "Tap the button to tag your location."
        )
    }
    ...
    val launcher =
        rememberLauncherForActivityResult(
            ...
            access = when {
                ...
                result[ACCESS_FINE_LOCATION] == true ->
                    "Precise"

                result[ACCESS_COARSE_LOCATION] == true ->
                    "Approximate"
